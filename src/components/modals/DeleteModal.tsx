  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Delete this ${type}?`}>
      <div className="flex flex-col gap-6">
        <p className="text-[var(--color-text-secondary)] text-[13px] leading-6">
        ...
        <div className="flex gap-4 w-full">
          ...
          <button
            onClick={onClose}
            className="flex-1 bg-[var(--color-bg-main)] text-[#635FC7] font-bold py-2 rounded-full hover:bg-[#D8D7F1] transition-colors text-[13px]"
          >
            Cancel
          </button>
        </div>
